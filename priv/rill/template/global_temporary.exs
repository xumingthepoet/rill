defmodule Template.Module do
  ...
  @spec create(id :: any, data :: any) ::
          {:ok, pid}
          | {:error, {:already_started, pid}}
          | {:error, any}
  def create(id, data) do
    @supervisor_name.start_child(data, id: id)
  end

  def global_name(id) do
    {__MODULE__, id}
  end

  def start_link({data, id: id}, _opts \\ []) do
    GenServer.start_link(__MODULE__, data, name: {:global, global_name(id)})
  end
  ...
  defmodule Supervisor do
    ...
    def start_child(data, id: id) do
      Elixir.Supervisor.start_child(__MODULE__, [{data, id: id}])
    end
